...
@clients_blueprint.route("/user/<int:user_id>/clients", methods=["POST"])
@token_required
@user_resource
...
@clients_blueprint.route("/user/<int:user_id>/clients/<int:client_id>", methods=["GET"])
@token_required
@user_resource
...
@clients_blueprint.route("/user/<int:user_id>/clients/<int:client_id>", methods=["DELETE"])
@token_required
@user_resource
...
@clients_blueprint.route("/user/<int:user_id>/clients/<int:client_id>", methods=["PUT"])
@token_required
@user_resource
