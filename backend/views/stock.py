...
@stock_blueprint.route("/user/<int:user_id>/products", methods=["GET"])
@token_required
@user_resource
...
@stock_blueprint.route("/user/<int:user_id>/products", methods = ["POST"])
@token_required
@user_resource
...
@stock_blueprint.route("/user/<int:user_id>/products/<int:product_id>", methods = ["GET"])
@token_required
@user_resource
...
@stock_blueprint.route("/user/<int:user_id>/products/<int:product_id>", methods = ["DELETE"])
@token_required
@user_resource
...
@stock_blueprint.route("/user/<int:user_id>/products/<int:product_id>", methods = ["PUT"])
@token_required
@user_resource
