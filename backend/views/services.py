...
from models.data_models import Service
...
@services_blueprint.route("/user/<int:user_id>/services", methods=["GET"])
@token_required
@user_resource
...
@services_blueprint.route("/user/<int:user_id>/services", methods = ["POST"])
@token_required
@user_resource
...
@services_blueprint.route("/user/<int:user_id>/services/<int:service_id>", methods = ["GET"])
@token_required
@user_resource
...
@services_blueprint.route("/user/<int:user_id>/services/<int:service_id>", methods = ["DELETE"])
@token_required
@user_resource
...
@services_blueprint.route("/user/<int:user_id>/services/<int:service_id>", methods = ["PUT"])
@token_required
@user_resource
